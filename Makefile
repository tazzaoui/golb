...
docs: gentoo_install_notes pairing_and_using_bluetooth_devices_on_arch_linux setting_up_tor_on_arch_linux the_cloud_is_someone_elses_computer a_blogging_system_in_less_than_100_lines_of_code matrix_multiply indexer snells_law rc_circuits_odes uniform_magnetic_fields electric_forces_and_fields web_crawler search_engine integral_roots runga_kutta euler_ode gradient_descent binary_bomb_4 binary_bomb_3 binary_bomb_2 binary_bomb_1 binary_bomb_0 


gentoo_install_notes: src/gentoo_install_notes.md
	./md2html.sh gentoo_install_notes.md
	mv gentoo_install_notes.html $(BLOG_DIR)
